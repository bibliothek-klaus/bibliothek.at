...
namespace bibliothek.at.Controllers
{
    public class MedienController : Controller
    {
        ...
        private readonly IEnhanceMedia _enhanceMedia;
        ...
        //public IActionResult Sitemap(string mediaType)
        //{
        ...
        //[OutputCache(Duration = 3600)]
        public IActionResult Neuanschaffungen()
        {
        ...
        public IActionResult Zeitschriften()
        {
        ...
        [HttpPost]
        public IActionResult QuickSearch(string search)
        {
        ...
        [HttpPost]
        public IActionResult Suche(SearchRequest request)
        {
